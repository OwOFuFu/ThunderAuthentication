...
public class Config {
     ...
     *
     * @param ConfigName-File Name, Config-Element Name,  Default value
     */
    ...
    public void reloadConfiguration() {
        ...
        loginPermission		= GetSetting(c,"login.permission.permission"		,"thunderauthentication.requirelogin");
        ...
        passwordHashType	= GetSetting(c,"passwords.hash_type"				,"THUNDERAUTHENTICATION");
        ...
        MySqlDbDbse			= GetSetting(c,"saving.mysql_database"				,"TData");
        MySqlOption			= GetSetting(c,"saving.mysql_dboption"				,"useSSL=false&autoReconnect=true");
        MySqlDbUser			= GetSetting(c,"saving.mysql_username"				,"TUser");
        MySqlDbPswd			= GetSetting(c,"saving.mysql_password"				,"TPswd");
