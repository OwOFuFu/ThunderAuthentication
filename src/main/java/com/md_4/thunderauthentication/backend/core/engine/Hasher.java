...
public class Hasher {
    ...
    private static String getType(String type) {
        ...
        else if (type.equalsIgnoreCase("rauth"))  return  "THUNDERAUTHENTICATION"; // Old RoyalAuth Hasher
        else if (type.equalsIgnoreCase("tauth")) return "THUNDERAUTHENTICATION";
        else return type;
    }

    private static String hash(String data, String type) throws NoSuchAlgorithmException {
        String rtype = Hasher.getType(type);
        if (rtype.equals("THUNDERAUTHENTICATION")) rtype = "SHA-512";
    ...
    public static String encrypt(String data, String type) throws NoSuchAlgorithmException {
        ...
        if (rtype.equals("THUNDERAUTHENTICATION")) {
